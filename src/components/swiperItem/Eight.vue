<template>
    <div class="page-box">
        ...
        <div class="content-box" :class="{ miniprogramTop: isMiniprogram }">
            ...
            >
                <span>超过了全市</span>
                <span class="color-orange">{{ shopReport.topPercent || 0}}%</span>
                <span>的店铺</span>
            </div>
            <!-- 累计收益相关····需要判断点击显示隐藏  -->
            <div
...
export default {
    ...
    watch: {
        swiperIndex() {
            setTimeout(() => {
                this.$emit('swiperItemLoaded','swiperItemLoaded_7')
            },6000)   
        },
    },
    computed: {
    ...
    methods: {
        ...mapMutations({
            setPosterSetting: "bill/setPosterSetting",
        }),
