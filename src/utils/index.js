...
export function setLocalStorage(STORAGE_KEY, data) {
    return window.localStorage.setItem(STORAGE_KEY, JSON.stringify(data))
}

export function getLocalStorage(STORAGE_KEY) {
    return JSON.parse(window.localStorage.getItem(STORAGE_KEY)) || null
}

export function removeLocalStorage(STORAGE_KEY) {
...
export function checkIsIOS() {
    ...
    // let result = isIOS ? '是iOS设备' : '不是iOS设备';
    // console.log('checkIsIOS:',result);
    return isIOS;
  }