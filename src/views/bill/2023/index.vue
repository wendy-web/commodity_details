    ...
    <div class="app-container">
        <div class="swiper-box">
            ...
            <swiper :options="swiperOption" ref="mySwiper" id="mySwiper">
                ...
                <swiper-slide
                    :id="
                        swiperItemLoadedArr[activeIndex]
                            ? `tttt${swiperItemLoadedArr[activeIndex]}`
                            : `fff${activeIndex}-${swiperItemLoadedArr}`
                    "
                    class="swiper_slide_item"
                    :class="{
                        'swiper-no-swiping': !swiperItemLoadedArr[activeIndex],
                    }"
                >
                    <Two
                        @audioPlay="audioPlay"
                        ...
                        @stopAudio="stopAudio"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_1="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <!-- 累计开箱有数据、惠商时候才显示 -->
                <swiper-slide
                ...
                >
                    <Three
                        ...
                        :swiperIndex="activeIndex"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_2="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <!-- 累计收益合计存在才显示 -->
                <swiper-slide
                ...
                >
                    <Four
                        ...
                        :swiperIndex="activeIndex"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_3="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <!-- 累计获得卡券数据为0不显示 -->
                <swiper-slide
                    v-if="shopReport && shopReport.totalTicketQty > 0"
                    class="swiper_slide_item"
                    :class="{
                        'swiper-no-swiping': !swiperItemLoadedArr[activeIndex],
                    }"
                >
                    <Five
                        ...
                        :swiperIndex="activeIndex"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_4="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <!-- 惠商系统显示 累计采购订单有数据才显示 -->
                <swiper-slide
                ...
                >
                    <Six
                        ...
                        :swiperIndex="activeIndex"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_5="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <!-- 第七页 付出的一年：兑奖人数为0 不显示 -->
                <swiper-slide
                    v-if="shopReport && shopReport.exUserQty > 0"
                    class="swiper_slide_item"
                    :class="{
                        'swiper-no-swiping': !swiperItemLoadedArr[activeIndex],
                    }"
                >
                    <Seven
                        ...
                        :swiperIndex="activeIndex"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_6="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
                <swiper-slide
                    class="swiper_slide_item"
                ...
                >
                    <Eight
                        ...
                        :swiperLength="swiperLength"
                        @swiperItemLoaded="swiperItemLoaded"
                        :swiperItemLoaded_7="swiperItemLoadedArr[activeIndex]"
                    />
                </swiper-slide>
        ...
        <audio id="audio" ref="audioRef" loop hidden @ended="audioFinished">
...
export default {
    ...
    created() {
        ...
        dsBridge.register("stopAudio", () => {
            //funName:方法名，data:原生传过来的数据
            this.stopAudio();
        });
        dsBridge.register("playedAudio", () => {
            //funName:方法名，data:原生传过来的数据
            this.playedAudio();
        });
    },
    ...
    methods: {
        ...
        swiperItemLoaded() {
            let arr = this.swiperItemLoadedArr;
            arr[this.activeIndex] = true;
            this.swiperItemLoadedArr = arr;
            // console.log("swiperItemLoaded:", this.swiperItemLoadedArr);
        },
    },
    watch: {
        isPlay(playing) {
